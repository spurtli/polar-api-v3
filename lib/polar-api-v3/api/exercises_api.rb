...
module Polar
  class ExercisesApi
    ...
    def get_exercise_fit_without_transaction_with_http_info(exercise_id, opts = {})
      ...
      # resource path
      local_var_path = '/v3/exercises/{exerciseId}/fit'.sub('{' + 'exerciseId' + '}', CGI.escape(exercise_id.to_s).gsub('%2F', '/'))
    ...
    def get_exercise_without_transaction_with_http_info(exercise_id, opts = {})
      ...
      # resource path
      local_var_path = '/v3/exercises/{exerciseId}'.sub('{' + 'exerciseId' + '}', CGI.escape(exercise_id.to_s).gsub('%2F', '/'))
