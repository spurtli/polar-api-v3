...
module Polar
  class PhysicalInfoApi
    ...
    def commit_physical_info_transaction_with_http_info(transaction_id, user_id, opts = {})
      ...
      # resource path
      local_var_path = '/v3/users/{user-id}/physical-information-transactions/{transaction-id}'.sub('{' + 'transaction-id' + '}', CGI.escape(transaction_id.to_s).gsub('%2F', '/')).sub('{' + 'user-id' + '}', CGI.escape(user_id.to_s).gsub('%2F', '/'))
    ...
    def create_physical_info_transaction_with_http_info(user_id, opts = {})
      ...
      # resource path
      local_var_path = '/v3/users/{user-id}/physical-information-transactions'.sub('{' + 'user-id' + '}', CGI.escape(user_id.to_s).gsub('%2F', '/'))
    ...
    def get_physical_info_with_http_info(user_id, transaction_id, physical_info_id, opts = {})
      ...
      # resource path
      local_var_path = '/v3/users/{user-id}/physical-information-transactions/{transaction-id}/physical-informations/{physical-info-id}'.sub('{' + 'user-id' + '}', CGI.escape(user_id.to_s).gsub('%2F', '/')).sub('{' + 'transaction-id' + '}', CGI.escape(transaction_id.to_s).gsub('%2F', '/')).sub('{' + 'physical-info-id' + '}', CGI.escape(physical_info_id.to_s).gsub('%2F', '/'))
